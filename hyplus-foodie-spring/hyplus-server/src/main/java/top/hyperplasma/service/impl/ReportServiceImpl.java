...
import top.hyperplasma.service.WorkspaceService;
import top.hyperplasma.vo.*;
...
public class ReportServiceImpl implements ReportService {
    ...
    public OrderReportVO getOrdersStatistics(LocalDate begin, LocalDate end) {
        ...
        for (LocalDate date : dateList) {
            ...
            // 查询每天的有效订单数 select count(id) from orders where order_time > ? and order_time < ? and status = %Orders.COMPLETED%
