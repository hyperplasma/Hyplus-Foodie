...
import top.hyperplasma.utils.WeChatPayUtil;
...
public class OrderServiceImpl implements OrderService {
    ...
    @Value("${hyplus.shop.address}")
    private String shopAddress;

    @Value("${hyplus.baidu.ak}")
    private String ak;
